...
#define BFO_PITCH_PIN 4           // GPIO per il potenziometro pitch BFO
#define BFO_PITCH_RANGE 400       // ±200Hz range totale (più fine)
#define BFO_PITCH_CENTER 200      // Centro del range
#define BFO_PITCH_DEADZONE 0      // Deadzone più piccola per controllo fine
