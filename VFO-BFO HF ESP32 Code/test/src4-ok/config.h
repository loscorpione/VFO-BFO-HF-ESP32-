...
// Colori S-meter
#define S_METER_LOW_COLOR TFT_GREEN     // S1-S5
#define S_METER_MEDIUM_COLOR TFT_YELLOW // S6-S8
#define S_METER_HIGH_COLOR TFT_RED      // S9+
#define S_METER_BG_COLOR TFT_DARKGREY   // Sfondo segmenti
#define S_METER_BORDER_COLOR TFT_WHITE  // Bordo
